...
const HARD = [
  ...
  { player:"Trent Dilfer", sport:"🏈 NFL", answer:"TRENT DILFER", era:"modern", stats:{RTG:"70.2",SB:"Won 2001",PICK:"6th 1994",TEAM:"Ravens"}, ctx:"Super Bowl XXXV Champion — Won as game-manager for the Ravens", clues:["Won Super Bowl XXXV as a game-manager QB despite a career 70.2 passer rating","Was released by the Baltimore Ravens shortly after winning the Super Bowl","Was the 6th overall pick in the 1994 NFL Draft","From Santa Cruz California — became a well-known football analyst after retiring"] },
  ...
  { player:"Trent Dilfer", sport:"🏈 NFL", answer:"TRENT DILFER HARD", era:"modern", stats:{YDS:"153",TD:"1",INT:"0",RTG:"112.8"}, ctx:"Super Bowl XXXV MVP team — Baltimore Ravens", clues:["Won the Super Bowl with the Baltimore Ravens","Was considered the weakest link on a dominant defense-led team","Had been cut by Tampa Bay before winning the championship","Scored 1 touchdowns during this season"] },
  ...
  { player:"Vinicius Junior", sport:"⚽ Soccer", answer:"VINICIUS JUNIOR", era:"modern", stats:{UCL:"2022",GOALS:"15",NATION:"Brazil",CLUB:"Real Madrid"}, ctx:"2021-22 Champions League — Scored the winner in the final", clues:["Scored the winning goal in the 2022 Champions League Final for Real Madrid against Liverpool","Was signed by Real Madrid for 45 million euros as a 16-year-old Brazilian prodigy","Became one of the most exciting attackers in world football","From São Gonçalo Brazil — faced racist abuse from opposition fans during his career"] },
  ...
  { player:"Dominic Thiem", sport:"🎾 ATP", answer:"DOMINIC THIEM_2", era:"modern", stats:{SLAM:"2020 US Open",FINALS:"3",NATION:"Austria",COMEBACK:"Wrist"}, ctx:"Career Totals — Austria's first Grand Slam champion", clues:["Won the 2020 US Open — the first Austrian man to win a Grand Slam","Reached three Grand Slam finals before finally winning the fourth","Overcame a serious wrist injury that kept him out for almost an entire year","From Wiener Neustadt Austria — learned the game from his father Wolfgang who is also a tennis coach"] },

  // MEDIUM Golf Modern (need 1)
  { player:"Hideki Matsuyama", sport:"⛳ Golf", answer:"HIDEKI MATSUYAMA", era:"modern", stats:{MASTERS:"2021",NATION:"Japan",FIRST:"Asian man",WINS:"8"}, ctx:"2021 Masters — First Japanese man to win a major", clues:["Won the 2021 Masters — the first Japanese man to win a major championship","Won 8 PGA Tour events making him one of the most successful Asian players ever","Was a decorated amateur before turning professional in Japan","From Matsuyama Japan — his caddie bowed to Augusta National after his victory in a famous moment"] },
