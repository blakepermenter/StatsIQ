...
// ─── MASTER ATHLETE LIST (for autocomplete) ───────────────────────────────────
type AthleteEntry = { name: string; sport: string; era: Era };
const ATHLETES: AthleteEntry[] = [// ─── BASKETBALL (NBA) ────────────────────────────────────────────────────────
  // Modern (2000s-now)
  { name: "LeBron James", sport: "🏀", era: "modern" },
  { name: "Stephen Curry", sport: "🏀", era: "modern" },
  { name: "Kevin Durant", sport: "🏀", era: "modern" },
  { name: "Giannis Antetokounmpo", sport: "🏀", era: "modern" },
  { name: "Nikola Jokic", sport: "🏀", era: "modern" },
  { name: "Joel Embiid", sport: "🏀", era: "modern" },
  { name: "Luka Doncic", sport: "🏀", era: "modern" },
  { name: "Kawhi Leonard", sport: "🏀", era: "modern" },
  { name: "Damian Lillard", sport: "🏀", era: "modern" },
  { name: "James Harden", sport: "🏀", era: "modern" },
  { name: "Russell Westbrook", sport: "🏀", era: "modern" },
  { name: "Anthony Davis", sport: "🏀", era: "modern" },
  { name: "Kobe Bryant", sport: "🏀", era: "modern" },
  { name: "Dwyane Wade", sport: "🏀", era: "modern" },
  { name: "Chris Paul", sport: "🏀", era: "modern" },
  { name: "Paul George", sport: "🏀", era: "modern" },
  { name: "Jimmy Butler", sport: "🏀", era: "modern" },
  { name: "Jayson Tatum", sport: "🏀", era: "modern" },
  { name: "Devin Booker", sport: "🏀", era: "modern" },
  { name: "Trae Young", sport: "🏀", era: "modern" },
  { name: "Ja Morant", sport: "🏀", era: "modern" },
  { name: "Zion Williamson", sport: "🏀", era: "modern" },
  { name: "Donovan Mitchell", sport: "🏀", era: "modern" },
  { name: "Bam Adebayo", sport: "🏀", era: "modern" },
  { name: "Rudy Gobert", sport: "🏀", era: "modern" },
  { name: "Ben Simmons", sport: "🏀", era: "modern" },
  { name: "Kyrie Irving", sport: "🏀", era: "modern" },
  { name: "Blake Griffin", sport: "🏀", era: "modern" },
  { name: "Draymond Green", sport: "🏀", era: "modern" },
  { name: "Klay Thompson", sport: "🏀", era: "modern" },
  { name: "Vince Carter", sport: "🏀", era: "modern" },
  { name: "Tracy McGrady", sport: "🏀", era: "modern" },
  { name: "Dirk Nowitzki", sport: "🏀", era: "modern" },
  { name: "Steve Nash", sport: "🏀", era: "modern" },
  { name: "Shaquille O'Neal", sport: "🏀", era: "modern" },
  { name: "Allen Iverson", sport: "🏀", era: "modern" },
  { name: "Ron Artest", sport: "🏀", era: "modern" },
  { name: "Jeremy Lin", sport: "🏀", era: "modern" },
  { name: "Caitlin Clark", sport: "🏀", era: "modern" },
  { name: "A'ja Wilson", sport: "🏀", era: "modern" },
  { name: "Breanna Stewart", sport: "🏀", era: "modern" },
  { name: "Diana Taurasi", sport: "🏀", era: "modern" },
  { name: "Sue Bird", sport: "🏀", era: "modern" },
  { name: "Maya Moore", sport: "🏀", era: "modern" },
  { name: "Candace Parker", sport: "🏀", era: "modern" },
  { name: "DeMar DeRozan", sport: "🏀", era: "modern" },
  { name: "Paul Pierce", sport: "🏀", era: "modern" },
  { name: "Ray Allen", sport: "🏀", era: "modern" },
  { name: "Kevin Garnett", sport: "🏀", era: "modern" },
  { name: "Carmelo Anthony", sport: "🏀", era: "modern" },
  { name: "Dwight Howard", sport: "🏀", era: "modern" },
  { name: "Amar'e Stoudemire", sport: "🏀", era: "modern" },
  { name: "Chris Bosh", sport: "🏀", era: "modern" },
  { name: "Pau Gasol", sport: "🏀", era: "modern" },
  { name: "Marc Gasol", sport: "🏀", era: "modern" },
  { name: "Tony Parker", sport: "🏀", era: "modern" },
  { name: "Manu Ginobili", sport: "🏀", era: "modern" },
  { name: "Tim Duncan", sport: "🏀", era: "modern" },
  { name: "Yao Ming", sport: "🏀", era: "modern" },
  { name: "Gilbert Arenas", sport: "🏀", era: "modern" },
  { name: "Derrick Rose", sport: "🏀", era: "modern" },
  { name: "Rajon Rondo", sport: "🏀", era: "modern" },
  { name: "Metta World Peace", sport: "🏀", era: "modern" },
  { name: "Lamar Odom", sport: "🏀", era: "modern" },
  { name: "Antawn Jamison", sport: "🏀", era: "modern" },
  { name: "Peja Stojakovic", sport: "🏀", era: "modern" },
  { name: "Dirk Nowitzki", sport: "🏀", era: "modern" },
  { name: "Mike Bibby", sport: "🏀", era: "modern" },
  { name: "Baron Davis", sport: "🏀", era: "modern" },
  { name: "Andre Iguodala", sport: "🏀", era: "modern" },
  { name: "Luol Deng", sport: "🏀", era: "modern" },
  { name: "Brook Lopez", sport: "🏀", era: "modern" },
  { name: "LaMarcus Aldridge", sport: "🏀", era: "modern" },
  { name: "Kyle Lowry", sport: "🏀", era: "modern" },
  { name: "DeMarcus Cousins", sport: "🏀", era: "modern" },
  { name: "Kevin Love", sport: "🏀", era: "modern" },
  { name: "Brandon Roy", sport: "🏀", era: "modern" },
  { name: "Danny Granger", sport: "🏀", era: "modern" },
  { name: "Melo Trimble", sport: "🏀", era: "modern" },
  { name: "Nikola Vucevic", sport: "🏀", era: "modern" },
  { name: "Khris Middleton", sport: "🏀", era: "modern" },
  { name: "Jrue Holiday", sport: "🏀", era: "modern" },
  { name: "Fred VanVleet", sport: "🏀", era: "modern" },
  { name: "Pascal Siakam", sport: "🏀", era: "modern" },
  { name: "OG Anunoby", sport: "🏀", era: "modern" },
  { name: "Jaylen Brown", sport: "🏀", era: "modern" },
  { name: "Marcus Smart", sport: "🏀", era: "modern" },
  { name: "Tyrese Haliburton", sport: "🏀", era: "modern" },
  { name: "De'Aaron Fox", sport: "🏀", era: "modern" },
  { name: "Shai Gilgeous-Alexander", sport: "🏀", era: "modern" },
  { name: "Scottie Barnes", sport: "🏀", era: "modern" },
  { name: "Paolo Banchero", sport: "🏀", era: "modern" },
  { name: "Victor Wembanyama", sport: "🏀", era: "modern" },
  { name: "Cade Cunningham", sport: "🏀", era: "modern" },
  { name: "Evan Mobley", sport: "🏀", era: "modern" },
  { name: "Jaren Jackson Jr.", sport: "🏀", era: "modern" },
  { name: "Desmond Bane", sport: "🏀", era: "modern" },
  { name: "Jordan Poole", sport: "🏀", era: "modern" },
  { name: "Andrew Wiggins", sport: "🏀", era: "modern" },
  { name: "Miles Bridges", sport: "🏀", era: "modern" },
  // Classic (1970s-1990s)
  { name: "Michael Jordan", sport: "🏀", era: "classic" },
  { name: "Magic Johnson", sport: "🏀", era: "classic" },
  { name: "Larry Bird", sport: "🏀", era: "classic" },
  { name: "Charles Barkley", sport: "🏀", era: "classic" },
  { name: "Patrick Ewing", sport: "🏀", era: "classic" },
  { name: "Hakeem Olajuwon", sport: "🏀", era: "classic" },
  { name: "Scottie Pippen", sport: "🏀", era: "classic" },
  { name: "Dennis Rodman", sport: "🏀", era: "classic" },
  { name: "Reggie Miller", sport: "🏀", era: "classic" },
  { name: "John Stockton", sport: "🏀", era: "classic" },
  { name: "Karl Malone", sport: "🏀", era: "classic" },
  { name: "Clyde Drexler", sport: "🏀", era: "classic" },
  { name: "Dominique Wilkins", sport: "🏀", era: "classic" },
  { name: "Isiah Thomas", sport: "🏀", era: "classic" },
  { name: "David Robinson", sport: "🏀", era: "classic" },
  { name: "Gary Payton", sport: "🏀", era: "classic" },
  { name: "Alonzo Mourning", sport: "🏀", era: "classic" },
  { name: "Shawn Kemp", sport: "🏀", era: "classic" },
  { name: "Chris Mullin", sport: "🏀", era: "classic" },
  { name: "Mitch Richmond", sport: "🏀", era: "classic" },
  { name: "Anfernee Hardaway", sport: "🏀", era: "classic" },
  { name: "Grant Hill", sport: "🏀", era: "classic" },
  { name: "Latrell Sprewell", sport: "🏀", era: "classic" },
  { name: "Detlef Schrempf", sport: "🏀", era: "classic" },
  { name: "Mark Price", sport: "🏀", era: "classic" },
  { name: "Brad Daugherty", sport: "🏀", era: "classic" },
  { name: "Terry Cummings", sport: "🏀", era: "classic" },
  { name: "Xavier McDaniel", sport: "🏀", era: "classic" },
  { name: "Buck Williams", sport: "🏀", era: "classic" },
  { name: "Kevin McHale", sport: "🏀", era: "classic" },
  { name: "Robert Parish", sport: "🏀", era: "classic" },
  { name: "Dennis Johnson", sport: "🏀", era: "classic" },
  { name: "Byron Scott", sport: "🏀", era: "classic" },
  { name: "James Worthy", sport: "🏀", era: "classic" },
  { name: "A.C. Green", sport: "🏀", era: "classic" },
  { name: "Bill Laimbeer", sport: "🏀", era: "classic" },
  { name: "Joe Dumars", sport: "🏀", era: "classic" },
  { name: "Vinnie Johnson", sport: "🏀", era: "classic" },
  { name: "Mark Aguirre", sport: "🏀", era: "classic" },
  { name: "Adrian Dantley", sport: "🏀", era: "classic" },
  { name: "Bernard King", sport: "🏀", era: "classic" },
  { name: "Alex English", sport: "🏀", era: "classic" },
  { name: "Dan Issel", sport: "🏀", era: "classic" },
  { name: "Artis Gilmore", sport: "🏀", era: "classic" },
  { name: "Bob Lanier", sport: "🏀", era: "classic" },
  { name: "Spencer Haywood", sport: "🏀", era: "classic" },
  { name: "Pete Maravich", sport: "🏀", era: "classic" },
  { name: "Kareem Abdul-Jabbar", sport: "🏀", era: "classic" },
  { name: "Moses Malone", sport: "🏀", era: "classic" },
  { name: "Julius Erving", sport: "🏀", era: "classic" },
  { name: "Bob McAdoo", sport: "🏀", era: "classic" },
  { name: "World B. Free", sport: "🏀", era: "classic" },
  { name: "Nate Archibald", sport: "🏀", era: "classic" },
  { name: "Dave Cowens", sport: "🏀", era: "classic" },
  { name: "Jo Jo White", sport: "🏀", era: "classic" },
  { name: "Paul Westphal", sport: "🏀", era: "classic" },
  { name: "Walter Davis", sport: "🏀", era: "classic" },
  { name: "Truck Robinson", sport: "🏀", era: "classic" },
  // Legends (pre-1970s)
  { name: "Wilt Chamberlain", sport: "🏀", era: "legends" },
  { name: "Bill Russell", sport: "🏀", era: "legends" },
  { name: "Oscar Robertson", sport: "🏀", era: "legends" },
  { name: "Jerry West", sport: "🏀", era: "legends" },
  { name: "Elgin Baylor", sport: "🏀", era: "legends" },
  { name: "Bob Pettit", sport: "🏀", era: "legends" },
  { name: "Bob Cousy", sport: "🏀", era: "legends" },
  { name: "Hal Greer", sport: "🏀", era: "legends" },
  { name: "Dolph Schayes", sport: "🏀", era: "legends" },
  { name: "George Mikan", sport: "🏀", era: "legends" },
  { name: "Willis Reed", sport: "🏀", era: "legends" },
  { name: "Dave DeBusschere", sport: "🏀", era: "legends" },
  { name: "Walt Frazier", sport: "🏀", era: "legends" },
  { name: "Earl Monroe", sport: "🏀", era: "legends" },
  { name: "Rick Barry", sport: "🏀", era: "legends" },
  { name: "Nate Thurmond", sport: "🏀", era: "legends" },
  { name: "Billy Cunningham", sport: "🏀", era: "legends" },
  { name: "Chet Walker", sport: "🏀", era: "legends" },
  { name: "Sam Jones", sport: "🏀", era: "legends" },
  { name: "K.C. Jones", sport: "🏀", era: "legends" },
  { name: "John Havlicek", sport: "🏀", era: "legends" },
  { name: "Tom Heinsohn", sport: "🏀", era: "legends" },
  { name: "Lenny Wilkens", sport: "🏀", era: "legends" },
  { name: "Lou Hudson", sport: "🏀", era: "legends" },
  { name: "Connie Hawkins", sport: "🏀", era: "legends" },

  // ─── FOOTBALL (NFL) ──────────────────────────────────────────────────────────
  // Modern
  { name: "Tom Brady", sport: "🏈", era: "modern" },
  { name: "Patrick Mahomes", sport: "🏈", era: "modern" },
  { name: "Aaron Rodgers", sport: "🏈", era: "modern" },
  { name: "Peyton Manning", sport: "🏈", era: "modern" },
  { name: "Josh Allen", sport: "🏈", era: "modern" },
  { name: "Lamar Jackson", sport: "🏈", era: "modern" },
  { name: "Drew Brees", sport: "🏈", era: "modern" },
  { name: "Travis Kelce", sport: "🏈", era: "modern" },
  { name: "Randy Moss", sport: "🏈", era: "modern" },
  { name: "Calvin Johnson", sport: "🏈", era: "modern" },
  { name: "Odell Beckham Jr.", sport: "🏈", era: "modern" },
  { name: "Adrian Peterson", sport: "🏈", era: "modern" },
  { name: "LaDainian Tomlinson", sport: "🏈", era: "modern" },
  { name: "Marshall Faulk", sport: "🏈", era: "modern" },
  { name: "Bijan Robinson", sport: "🏈", era: "modern" },
  { name: "Justin Jefferson", sport: "🏈", era: "modern" },
  { name: "Davante Adams", sport: "🏈", era: "modern" },
  { name: "Tyreek Hill", sport: "🏈", era: "modern" },
  { name: "Stefon Diggs", sport: "🏈", era: "modern" },
  { name: "DeAndre Hopkins", sport: "🏈", era: "modern" },
  { name: "Antonio Brown", sport: "🏈", era: "modern" },
  { name: "Rob Gronkowski", sport: "🏈", era: "modern" },
  { name: "Terrell Owens", sport: "🏈", era: "modern" },
  { name: "Larry Fitzgerald", sport: "🏈", era: "modern" },
  { name: "Anquan Boldin", sport: "🏈", era: "modern" },
  { name: "Andre Johnson", sport: "🏈", era: "modern" },
  { name: "Marques Colston", sport: "🏈", era: "modern" },
  { name: "Greg Jennings", sport: "🏈", era: "modern" },
  { name: "Reggie Wayne", sport: "🏈", era: "modern" },
  { name: "Wes Welker", sport: "🏈", era: "modern" },
  { name: "Eli Manning", sport: "🏈", era: "modern" },
  { name: "Ben Roethlisberger", sport: "🏈", era: "modern" },
  { name: "Philip Rivers", sport: "🏈", era: "modern" },
  { name: "Matt Ryan", sport: "🏈", era: "modern" },
  { name: "Russell Wilson", sport: "🏈", era: "modern" },
  { name: "Cam Newton", sport: "🏈", era: "modern" },
  { name: "Andrew Luck", sport: "🏈", era: "modern" },
  { name: "Nick Foles", sport: "🏈", era: "modern" },
  { name: "Kurt Warner", sport: "🏈", era: "modern" },
  { name: "Malcolm Butler", sport: "🏈", era: "modern" },
  { name: "David Tyree", sport: "🏈", era: "modern" },
  { name: "Marshawn Lynch", sport: "🏈", era: "modern" },
  { name: "Frank Gore", sport: "🏈", era: "modern" },
  { name: "Arian Foster", sport: "🏈", era: "modern" },
  { name: "Chris Johnson", sport: "🏈", era: "modern" },
  { name: "Jamaal Charles", sport: "🏈", era: "modern" },
  { name: "DeMarco Murray", sport: "🏈", era: "modern" },
  { name: "Le'Veon Bell", sport: "🏈", era: "modern" },
  { name: "Ezekiel Elliott", sport: "🏈", era: "modern" },
  { name: "Derrick Henry", sport: "🏈", era: "modern" },
  { name: "Alvin Kamara", sport: "🏈", era: "modern" },
  { name: "Christian McCaffrey", sport: "🏈", era: "modern" },
  { name: "Dalvin Cook", sport: "🏈", era: "modern" },
  { name: "Nick Chubb", sport: "🏈", era: "modern" },
  { name: "Joe Mixon", sport: "🏈", era: "modern" },
  { name: "Jalen Hurts", sport: "🏈", era: "modern" },
  { name: "Justin Herbert", sport: "🏈", era: "modern" },
  { name: "Joe Burrow", sport: "🏈", era: "modern" },
  { name: "Tua Tagovailoa", sport: "🏈", era: "modern" },
  { name: "Trevor Lawrence", sport: "🏈", era: "modern" },
  { name: "CeeDee Lamb", sport: "🏈", era: "modern" },
  { name: "Cooper Kupp", sport: "🏈", era: "modern" },
  { name: "Ja'Marr Chase", sport: "🏈", era: "modern" },
  { name: "Von Miller", sport: "🏈", era: "modern" },
  { name: "Khalil Mack", sport: "🏈", era: "modern" },
  { name: "Aaron Donald", sport: "🏈", era: "modern" },
  { name: "J.J. Watt", sport: "🏈", era: "modern" },
  { name: "Luke Kuechly", sport: "🏈", era: "modern" },
  { name: "Bobby Wagner", sport: "🏈", era: "modern" },
  { name: "Patrick Willis", sport: "🏈", era: "modern" },
  { name: "Richard Sherman", sport: "🏈", era: "modern" },
  { name: "Darrelle Revis", sport: "🏈", era: "modern" },
  { name: "Ed Reed", sport: "🏈", era: "modern" },
  { name: "Troy Polamalu", sport: "🏈", era: "modern" },
  { name: "Brian Urlacher", sport: "🏈", era: "modern" },
  { name: "Ray Lewis", sport: "🏈", era: "modern" },
  { name: "Tim Tebow", sport: "🏈", era: "modern" },
  // Classic
  { name: "Jerry Rice", sport: "🏈", era: "classic" },
  { name: "Joe Montana", sport: "🏈", era: "classic" },
  { name: "Steve Young", sport: "🏈", era: "classic" },
  { name: "Barry Sanders", sport: "🏈", era: "classic" },
  { name: "Emmitt Smith", sport: "🏈", era: "classic" },
  { name: "Brett Favre", sport: "🏈", era: "classic" },
  { name: "Dan Marino", sport: "🏈", era: "classic" },
  { name: "Walter Payton", sport: "🏈", era: "classic" },
  { name: "Lawrence Taylor", sport: "🏈", era: "classic" },
  { name: "Reggie White", sport: "🏈", era: "classic" },
  { name: "Deion Sanders", sport: "🏈", era: "classic" },
  { name: "Ronnie Lott", sport: "🏈", era: "classic" },
  { name: "Anthony Munoz", sport: "🏈", era: "classic" },
  { name: "Mike Singletary", sport: "🏈", era: "classic" },
  { name: "Marcus Allen", sport: "🏈", era: "classic" },
  { name: "Herschel Walker", sport: "🏈", era: "classic" },
  { name: "Eric Dickerson", sport: "🏈", era: "classic" },
  { name: "Tony Dorsett", sport: "🏈", era: "classic" },
  { name: "Roger Staubach", sport: "🏈", era: "classic" },
  { name: "Terry Bradshaw", sport: "🏈", era: "classic" },
  { name: "Franco Harris", sport: "🏈", era: "classic" },
  { name: "Lynn Swann", sport: "🏈", era: "classic" },
  { name: "John Stallworth", sport: "🏈", era: "classic" },
  { name: "Mel Blount", sport: "🏈", era: "classic" },
  { name: "Jack Lambert", sport: "🏈", era: "classic" },
  { name: "Jack Ham", sport: "🏈", era: "classic" },
  { name: "Mean Joe Greene", sport: "🏈", era: "classic" },
  { name: "Lynn Swann", sport: "🏈", era: "classic" },
  { name: "Randy White", sport: "🏈", era: "classic" },
  { name: "Harvey Martin", sport: "🏈", era: "classic" },
  { name: "Drew Pearson", sport: "🏈", era: "classic" },
  { name: "Tony Hill", sport: "🏈", era: "classic" },
  { name: "Charlie Joiner", sport: "🏈", era: "classic" },
  { name: "John Jefferson", sport: "🏈", era: "classic" },
  { name: "Kellen Winslow Sr.", sport: "🏈", era: "classic" },
  { name: "Ozzie Newsome", sport: "🏈", era: "classic" },
  { name: "Steve Largent", sport: "🏈", era: "classic" },
  { name: "Art Monk", sport: "🏈", era: "classic" },
  { name: "Gary Clark", sport: "🏈", era: "classic" },
  { name: "Ricky Sanders", sport: "🏈", era: "classic" },
  { name: "Jim McMahon", sport: "🏈", era: "classic" },
  { name: "Phil Simms", sport: "🏈", era: "classic" },
  { name: "Jim Kelly", sport: "🏈", era: "classic" },
  { name: "Thurman Thomas", sport: "🏈", era: "classic" },
  { name: "Andre Reed", sport: "🏈", era: "classic" },
  { name: "Bruce Smith", sport: "🏈", era: "classic" },
  { name: "Cornelius Bennett", sport: "🏈", era: "classic" },
  // Legends
  { name: "Johnny Unitas", sport: "🏈", era: "legends" },
  { name: "Jim Brown", sport: "🏈", era: "legends" },
  { name: "Dick Butkus", sport: "🏈", era: "legends" },
  { name: "Gale Sayers", sport: "🏈", era: "legends" },
  { name: "Bart Starr", sport: "🏈", era: "legends" },
  { name: "Vince Lombardi", sport: "🏈", era: "legends" },
  { name: "Raymond Berry", sport: "🏈", era: "legends" },
  { name: "Lenny Moore", sport: "🏈", era: "legends" },
  { name: "Alan Ameche", sport: "🏈", era: "legends" },
  { name: "Y.A. Tittle", sport: "🏈", era: "legends" },
  { name: "Frank Gifford", sport: "🏈", era: "legends" },
  { name: "Sam Huff", sport: "🏈", era: "legends" },
  { name: "Don Maynard", sport: "🏈", era: "legends" },
  { name: "Lance Alworth", sport: "🏈", era: "legends" },
  { name: "Joe Namath", sport: "🏈", era: "legends" },
  { name: "Don Hutson", sport: "🏈", era: "legends" },
  { name: "Bobby Layne", sport: "🏈", era: "legends" },
  { name: "Norm Van Brocklin", sport: "🏈", era: "legends" },
  { name: "Chuck Bednarik", sport: "🏈", era: "legends" },
  { name: "Night Train Lane", sport: "🏈", era: "legends" },
  { name: "Emlen Tunnell", sport: "🏈", era: "legends" },
  { name: "Ollie Matson", sport: "🏈", era: "legends" },
  { name: "Hugh McElhenny", sport: "🏈", era: "legends" },
  { name: "Joe Perry", sport: "🏈", era: "legends" },
  { name: "Y.A. Tittle", sport: "🏈", era: "legends" },

  // ─── BASEBALL (MLB) ──────────────────────────────────────────────────────────
  // Modern
  { name: "Mike Trout", sport: "⚾", era: "modern" },
  { name: "Shohei Ohtani", sport: "⚾", era: "modern" },
  { name: "Albert Pujols", sport: "⚾", era: "modern" },
  { name: "Clayton Kershaw", sport: "⚾", era: "modern" },
  { name: "Derek Jeter", sport: "⚾", era: "modern" },
  { name: "Barry Bonds", sport: "⚾", era: "modern" },
  { name: "Ichiro Suzuki", sport: "⚾", era: "modern" },
  { name: "Jose Altuve", sport: "⚾", era: "modern" },
  { name: "Yordan Alvarez", sport: "⚾", era: "modern" },
  { name: "Mookie Betts", sport: "⚾", era: "modern" },
  { name: "Freddie Freeman", sport: "⚾", era: "modern" },
  { name: "Ronald Acuna Jr.", sport: "⚾", era: "modern" },
  { name: "Juan Soto", sport: "⚾", era: "modern" },
  { name: "Bryce Harper", sport: "⚾", era: "modern" },
  { name: "Aaron Judge", sport: "⚾", era: "modern" },
  { name: "Max Scherzer", sport: "⚾", era: "modern" },
  { name: "Jacob deGrom", sport: "⚾", era: "modern" },
  { name: "Mariano Rivera", sport: "⚾", era: "modern" },
  { name: "David Ortiz", sport: "⚾", era: "modern" },
  { name: "Alex Rodriguez", sport: "⚾", era: "modern" },
  { name: "Randy Johnson", sport: "⚾", era: "modern" },
  { name: "Pedro Martinez", sport: "⚾", era: "modern" },
  { name: "Sammy Sosa", sport: "⚾", era: "modern" },
  { name: "Ken Griffey Jr.", sport: "⚾", era: "modern" },
  { name: "Manny Ramirez", sport: "⚾", era: "modern" },
  { name: "David Wright", sport: "⚾", era: "modern" },
  { name: "Chase Utley", sport: "⚾", era: "modern" },
  { name: "Ryan Howard", sport: "⚾", era: "modern" },
  { name: "Jimmy Rollins", sport: "⚾", era: "modern" },
  { name: "Cole Hamels", sport: "⚾", era: "modern" },
  { name: "Roy Halladay", sport: "⚾", era: "modern" },
  { name: "Felix Hernandez", sport: "⚾", era: "modern" },
  { name: "Zack Greinke", sport: "⚾", era: "modern" },
  { name: "Corey Kluber", sport: "⚾", era: "modern" },
  { name: "Justin Verlander", sport: "⚾", era: "modern" },
  { name: "Chris Sale", sport: "⚾", era: "modern" },
  { name: "Gerrit Cole", sport: "⚾", era: "modern" },
  { name: "Blake Snell", sport: "⚾", era: "modern" },
  { name: "Spencer Strider", sport: "⚾", era: "modern" },
  { name: "Corbin Burnes", sport: "⚾", era: "modern" },
  { name: "Paul Goldschmidt", sport: "⚾", era: "modern" },
  { name: "Nolan Arenado", sport: "⚾", era: "modern" },
  { name: "Jose Ramirez", sport: "⚾", era: "modern" },
  { name: "Francisco Lindor", sport: "⚾", era: "modern" },
  { name: "Trea Turner", sport: "⚾", era: "modern" },
  { name: "Fernando Tatis Jr.", sport: "⚾", era: "modern" },
  { name: "Vladimir Guerrero Jr.", sport: "⚾", era: "modern" },
  { name: "Pete Alonso", sport: "⚾", era: "modern" },
  { name: "Cody Bellinger", sport: "⚾", era: "modern" },
  { name: "Corey Seager", sport: "⚾", era: "modern" },
  { name: "Marcus Semien", sport: "⚾", era: "modern" },
  { name: "Jose Fernandez", sport: "⚾", era: "modern" },
  { name: "Noah Syndergaard", sport: "⚾", era: "modern" },
  { name: "Matt Harvey", sport: "⚾", era: "modern" },
  { name: "Carlos Beltran", sport: "⚾", era: "modern" },
  { name: "Carlos Delgado", sport: "⚾", era: "modern" },
  { name: "Jim Thome", sport: "⚾", era: "modern" },
  { name: "Mike Piazza", sport: "⚾", era: "modern" },
  { name: "Greg Maddux", sport: "⚾", era: "modern" },
  { name: "Tom Glavine", sport: "⚾", era: "modern" },
  { name: "John Smoltz", sport: "⚾", era: "modern" },
  { name: "Chipper Jones", sport: "⚾", era: "modern" },
  { name: "Andruw Jones", sport: "⚾", era: "modern" },
  // Classic
  { name: "Hank Aaron", sport: "⚾", era: "classic" },
  { name: "Willie Mays", sport: "⚾", era: "classic" },
  { name: "Mickey Mantle", sport: "⚾", era: "classic" },
  { name: "Roger Clemens", sport: "⚾", era: "classic" },
  { name: "Nolan Ryan", sport: "⚾", era: "classic" },
  { name: "Frank Thomas", sport: "⚾", era: "classic" },
  { name: "Jeff Bagwell", sport: "⚾", era: "classic" },
  { name: "Tony Gwynn", sport: "⚾", era: "classic" },
  { name: "George Brett", sport: "⚾", era: "classic" },
  { name: "Wade Boggs", sport: "⚾", era: "classic" },
  { name: "Cal Ripken Jr.", sport: "⚾", era: "classic" },
  { name: "Ozzie Smith", sport: "⚾", era: "classic" },
  { name: "Rickey Henderson", sport: "⚾", era: "classic" },
  { name: "Dave Winfield", sport: "⚾", era: "classic" },
  { name: "Gary Carter", sport: "⚾", era: "classic" },
  { name: "Dwight Gooden", sport: "⚾", era: "classic" },
  { name: "Darryl Strawberry", sport: "⚾", era: "classic" },
  { name: "Kirk Gibson", sport: "⚾", era: "classic" },
  { name: "Orel Hershiser", sport: "⚾", era: "classic" },
  { name: "Jose Canseco", sport: "⚾", era: "classic" },
  { name: "Mark McGwire", sport: "⚾", era: "classic" },
  { name: "Paul Molitor", sport: "⚾", era: "classic" },
  { name: "Robin Yount", sport: "⚾", era: "classic" },
  { name: "Kirby Puckett", sport: "⚾", era: "classic" },
  { name: "Jack Morris", sport: "⚾", era: "classic" },
  { name: "Frank Viola", sport: "⚾", era: "classic" },
  { name: "Dave Stewart", sport: "⚾", era: "classic" },
  { name: "Catfish Hunter", sport: "⚾", era: "classic" },
  { name: "Reggie Jackson", sport: "⚾", era: "classic" },
  { name: "Rod Carew", sport: "⚾", era: "classic" },
  { name: "Jim Palmer", sport: "⚾", era: "classic" },
  { name: "Steve Carlton", sport: "⚾", era: "classic" },
  { name: "Mike Schmidt", sport: "⚾", era: "classic" },
  { name: "Pete Rose", sport: "⚾", era: "classic" },
  { name: "Johnny Bench", sport: "⚾", era: "classic" },
  { name: "Joe Morgan", sport: "⚾", era: "classic" },
  { name: "Tom Seaver", sport: "⚾", era: "classic" },
  { name: "Carl Yastrzemski", sport: "⚾", era: "classic" },
  { name: "Bob Gibson", sport: "⚾", era: "classic" },
  { name: "Denny McLain", sport: "⚾", era: "classic" },
  { name: "Harmon Killebrew", sport: "⚾", era: "classic" },
  { name: "Brooks Robinson", sport: "⚾", era: "classic" },
  { name: "Frank Robinson", sport: "⚾", era: "classic" },
  { name: "Luis Aparicio", sport: "⚾", era: "classic" },
  { name: "Ernie Banks", sport: "⚾", era: "classic" },
  // Legends
  { name: "Babe Ruth", sport: "⚾", era: "legends" },
  { name: "Lou Gehrig", sport: "⚾", era: "legends" },
  { name: "Ted Williams", sport: "⚾", era: "legends" },
  { name: "Joe DiMaggio", sport: "⚾", era: "legends" },
  { name: "Sandy Koufax", sport: "⚾", era: "legends" },
  { name: "Don Larsen", sport: "⚾", era: "legends" },
  { name: "Warren Spahn", sport: "⚾", era: "legends" },
  { name: "Stan Musial", sport: "⚾", era: "legends" },
  { name: "Jackie Robinson", sport: "⚾", era: "legends" },
  { name: "Roy Campanella", sport: "⚾", era: "legends" },
  { name: "Duke Snider", sport: "⚾", era: "legends" },
  { name: "Pee Wee Reese", sport: "⚾", era: "legends" },
  { name: "Yogi Berra", sport: "⚾", era: "legends" },
  { name: "Whitey Ford", sport: "⚾", era: "legends" },
  { name: "Phil Rizzuto", sport: "⚾", era: "legends" },
  { name: "Ty Cobb", sport: "⚾", era: "legends" },
  { name: "Honus Wagner", sport: "⚾", era: "legends" },
  { name: "Cy Young", sport: "⚾", era: "legends" },
  { name: "Walter Johnson", sport: "⚾", era: "legends" },
  { name: "Christy Mathewson", sport: "⚾", era: "legends" },
  { name: "Rogers Hornsby", sport: "⚾", era: "legends" },
  { name: "Fernando Valenzuela", sport: "⚾", era: "legends" },

  // ─── SOCCER ──────────────────────────────────────────────────────────────────
  // Modern
  { name: "Lionel Messi", sport: "⚽", era: "modern" },
  { name: "Cristiano Ronaldo", sport: "⚽", era: "modern" },
  { name: "Kylian Mbappe", sport: "⚽", era: "modern" },
  { name: "Erling Haaland", sport: "⚽", era: "modern" },
  { name: "Neymar Jr.", sport: "⚽", era: "modern" },
  { name: "Robert Lewandowski", sport: "⚽", era: "modern" },
  { name: "Kevin De Bruyne", sport: "⚽", era: "modern" },
  { name: "Mohamed Salah", sport: "⚽", era: "modern" },
  { name: "Virgil van Dijk", sport: "⚽", era: "modern" },
  { name: "Harry Kane", sport: "⚽", era: "modern" },
  { name: "Karim Benzema", sport: "⚽", era: "modern" },
  { name: "Luka Modric", sport: "⚽", era: "modern" },
  { name: "Toni Kroos", sport: "⚽", era: "modern" },
  { name: "Sergio Ramos", sport: "⚽", era: "modern" },
  { name: "Andres Iniesta", sport: "⚽", era: "modern" },
  { name: "Xavi Hernandez", sport: "⚽", era: "modern" },
  { name: "Antoine Griezmann", sport: "⚽", era: "modern" },
  { name: "Sadio Mane", sport: "⚽", era: "modern" },
  { name: "Luis Suarez", sport: "⚽", era: "modern" },
  { name: "Ronaldinho", sport: "⚽", era: "modern" },
  { name: "Xabi Alonso", sport: "⚽", era: "modern" },
  { name: "Andrea Pirlo", sport: "⚽", era: "modern" },
  { name: "Gareth Bale", sport: "⚽", era: "modern" },
  { name: "Landon Donovan", sport: "⚽", era: "modern" },
  { name: "Thierry Henry", sport: "⚽", era: "modern" },
  { name: "Didier Drogba", sport: "⚽", era: "modern" },
  { name: "Frank Lampard", sport: "⚽", era: "modern" },
  { name: "Steven Gerrard", sport: "⚽", era: "modern" },
  { name: "Wayne Rooney", sport: "⚽", era: "modern" },
  { name: "Paul Scholes", sport: "⚽", era: "modern" },
  { name: "Ryan Giggs", sport: "⚽", era: "modern" },
  { name: "Roberto Carlos", sport: "⚽", era: "modern" },
  { name: "Cafu", sport: "⚽", era: "modern" },
  { name: "Ronaldo Nazario", sport: "⚽", era: "modern" },
  { name: "Dimitar Berbatov", sport: "⚽", era: "modern" },
  { name: "Zlatan Ibrahimovic", sport: "⚽", era: "modern" },
  { name: "David Villa", sport: "⚽", era: "modern" },
  { name: "Fernando Torres", sport: "⚽", era: "modern" },
  { name: "Cesc Fabregas", sport: "⚽", era: "modern" },
  { name: "Mia Hamm", sport: "⚽", era: "modern" },
  { name: "Abby Wambach", sport: "⚽", era: "modern" },
  { name: "Alex Morgan", sport: "⚽", era: "modern" },
  { name: "Megan Rapinoe", sport: "⚽", era: "modern" },
  { name: "Carli Lloyd", sport: "⚽", era: "modern" },
  { name: "Hope Solo", sport: "⚽", era: "modern" },
  { name: "Sam Kerr", sport: "⚽", era: "modern" },
  // Classic
  { name: "Zinedine Zidane", sport: "⚽", era: "classic" },
  { name: "George Best", sport: "⚽", era: "classic" },
  { name: "Johan Cruyff", sport: "⚽", era: "classic" },
  { name: "Marco van Basten", sport: "⚽", era: "classic" },
  { name: "Ruud Gullit", sport: "⚽", era: "classic" },
  { name: "Frank Rijkaard", sport: "⚽", era: "classic" },
  { name: "Michel Platini", sport: "⚽", era: "classic" },
  { name: "Diego Maradona", sport: "⚽", era: "classic" },
  { name: "Roberto Baggio", sport: "⚽", era: "classic" },
  { name: "Dennis Bergkamp", sport: "⚽", era: "classic" },
  { name: "Patrick Kluivert", sport: "⚽", era: "classic" },
  { name: "Marc Overmars", sport: "⚽", era: "classic" },
  { name: "Lothar Matthaus", sport: "⚽", era: "classic" },
  { name: "Jurgen Klinsmann", sport: "⚽", era: "classic" },
  { name: "Karl-Heinz Rummenigge", sport: "⚽", era: "classic" },
  { name: "Franz Beckenbauer", sport: "⚽", era: "classic" },
  { name: "Gerd Muller", sport: "⚽", era: "classic" },
  { name: "Paolo Maldini", sport: "⚽", era: "classic" },
  { name: "Franco Baresi", sport: "⚽", era: "classic" },
  { name: "Alessandro Del Piero", sport: "⚽", era: "classic" },
  { name: "Gabriel Batistuta", sport: "⚽", era: "classic" },
  { name: "Hernan Crespo", sport: "⚽", era: "classic" },
  { name: "Rivaldo", sport: "⚽", era: "classic" },
  // Legends
  { name: "Pele", sport: "⚽", era: "legends" },
  { name: "Eusebio", sport: "⚽", era: "legends" },
  { name: "Just Fontaine", sport: "⚽", era: "legends" },
  { name: "Lev Yashin", sport: "⚽", era: "legends" },
  { name: "Helmut Rahn", sport: "⚽", era: "legends" },
  { name: "Gunnar Nordahl", sport: "⚽", era: "legends" },
  { name: "Stanley Matthews", sport: "⚽", era: "legends" },
  { name: "Tom Finney", sport: "⚽", era: "legends" },
  { name: "Bobby Charlton", sport: "⚽", era: "legends" },
  { name: "Bobby Moore", sport: "⚽", era: "legends" },
  { name: "Geoff Hurst", sport: "⚽", era: "legends" },

  // ─── TENNIS ──────────────────────────────────────────────────────────────────
  // Modern
  { name: "Roger Federer", sport: "🎾", era: "modern" },
  { name: "Rafael Nadal", sport: "🎾", era: "modern" },
  { name: "Novak Djokovic", sport: "🎾", era: "modern" },
  { name: "Serena Williams", sport: "🎾", era: "modern" },
  { name: "Jannik Sinner", sport: "🎾", era: "modern" },
  { name: "Carlos Alcaraz", sport: "🎾", era: "modern" },
  { name: "Daniil Medvedev", sport: "🎾", era: "modern" },
  { name: "Andy Murray", sport: "🎾", era: "modern" },
  { name: "Ashleigh Barty", sport: "🎾", era: "modern" },
  { name: "Iga Swiatek", sport: "🎾", era: "modern" },
  { name: "Naomi Osaka", sport: "🎾", era: "modern" },
  { name: "Simona Halep", sport: "🎾", era: "modern" },
  { name: "Victoria Azarenka", sport: "🎾", era: "modern" },
  { name: "Maria Sharapova", sport: "🎾", era: "modern" },
  { name: "Venus Williams", sport: "🎾", era: "modern" },
  { name: "Andy Roddick", sport: "🎾", era: "modern" },
  { name: "Lleyton Hewitt", sport: "🎾", era: "modern" },
  { name: "Marat Safin", sport: "🎾", era: "modern" },
  { name: "Juan Martin del Potro", sport: "🎾", era: "modern" },
  { name: "Stan Wawrinka", sport: "🎾", era: "modern" },
  { name: "Andrei Agassi", sport: "🎾", era: "modern" },
  { name: "Pete Sampras", sport: "🎾", era: "modern" },
  { name: "Gustavo Kuerten", sport: "🎾", era: "modern" },
  { name: "Kim Clijsters", sport: "🎾", era: "modern" },
  { name: "Justine Henin", sport: "🎾", era: "modern" },
  { name: "Lindsay Davenport", sport: "🎾", era: "modern" },
  { name: "Jennifer Capriati", sport: "🎾", era: "modern" },
  { name: "Martina Hingis", sport: "🎾", era: "modern" },
  { name: "Monica Seles", sport: "🎾", era: "modern" },
  // Classic
  { name: "Bjorn Borg", sport: "🎾", era: "classic" },
  { name: "John McEnroe", sport: "🎾", era: "classic" },
  { name: "Jimmy Connors", sport: "🎾", era: "classic" },
  { name: "Ivan Lendl", sport: "🎾", era: "classic" },
  { name: "Stefan Edberg", sport: "🎾", era: "classic" },
  { name: "Boris Becker", sport: "🎾", era: "classic" },
  { name: "Jim Courier", sport: "🎾", era: "classic" },
  { name: "Thomas Muster", sport: "🎾", era: "classic" },
  { name: "Mats Wilander", sport: "🎾", era: "classic" },
  { name: "Guillermo Vilas", sport: "🎾", era: "classic" },
  { name: "Steffi Graf", sport: "🎾", era: "classic" },
  { name: "Martina Navratilova", sport: "🎾", era: "classic" },
  { name: "Chris Evert", sport: "🎾", era: "classic" },
  { name: "Gabriela Sabatini", sport: "🎾", era: "classic" },
  { name: "Arantxa Sanchez Vicario", sport: "🎾", era: "classic" },
  { name: "Conchita Martinez", sport: "🎾", era: "classic" },
  { name: "Mary Joe Fernandez", sport: "🎾", era: "classic" },
  { name: "Goran Ivanisevic", sport: "🎾", era: "classic" },
  { name: "Pat Rafter", sport: "🎾", era: "classic" },
  { name: "Michael Chang", sport: "🎾", era: "classic" },
  { name: "Todd Martin", sport: "🎾", era: "classic" },
  { name: "Wayne Ferreira", sport: "🎾", era: "classic" },
  // Legends
  { name: "Rod Laver", sport: "🎾", era: "legends" },
  { name: "Ken Rosewall", sport: "🎾", era: "legends" },
  { name: "Arthur Ashe", sport: "🎾", era: "legends" },
  { name: "Ilie Nastase", sport: "🎾", era: "legends" },
  { name: "Margaret Court", sport: "🎾", era: "legends" },
  { name: "Billie Jean King", sport: "🎾", era: "legends" },
  { name: "Evonne Goolagong", sport: "🎾", era: "legends" },
  { name: "Virginia Ruzici", sport: "🎾", era: "legends" },
  { name: "Lew Hoad", sport: "🎾", era: "legends" },
  { name: "Pancho Gonzales", sport: "🎾", era: "legends" },

  // ─── GOLF ────────────────────────────────────────────────────────────────────
  // Modern
  { name: "Tiger Woods", sport: "⛳", era: "modern" },
  { name: "Rory McIlroy", sport: "⛳", era: "modern" },
  { name: "Dustin Johnson", sport: "⛳", era: "modern" },
  { name: "Brooks Koepka", sport: "⛳", era: "modern" },
  { name: "Jordan Spieth", sport: "⛳", era: "modern" },
  { name: "Justin Thomas", sport: "⛳", era: "modern" },
  { name: "Jon Rahm", sport: "⛳", era: "modern" },
  { name: "Scottie Scheffler", sport: "⛳", era: "modern" },
  { name: "Patrick Cantlay", sport: "⛳", era: "modern" },
  { name: "Collin Morikawa", sport: "⛳", era: "modern" },
  { name: "Xander Schauffele", sport: "⛳", era: "modern" },
  { name: "Sam Burns", sport: "⛳", era: "modern" },
  { name: "Max Homa", sport: "⛳", era: "modern" },
  { name: "Tony Finau", sport: "⛳", era: "modern" },
  { name: "Rickie Fowler", sport: "⛳", era: "modern" },
  { name: "Bubba Watson", sport: "⛳", era: "modern" },
  { name: "Phil Mickelson", sport: "⛳", era: "modern" },
  { name: "David Duval", sport: "⛳", era: "modern" },
  { name: "Jim Furyk", sport: "⛳", era: "modern" },
  { name: "Vijay Singh", sport: "⛳", era: "modern" },
  { name: "Ernie Els", sport: "⛳", era: "modern" },
  { name: "Retief Goosen", sport: "⛳", era: "modern" },
  { name: "Sergio Garcia", sport: "⛳", era: "modern" },
  { name: "Adam Scott", sport: "⛳", era: "modern" },
  { name: "Jason Day", sport: "⛳", era: "modern" },
  { name: "Henrik Stenson", sport: "⛳", era: "modern" },
  { name: "Annika Sorenstam", sport: "⛳", era: "modern" },
  { name: "Lorena Ochoa", sport: "⛳", era: "modern" },
  { name: "Inbee Park", sport: "⛳", era: "modern" },
  { name: "Lydia Ko", sport: "⛳", era: "modern" },
  { name: "Nelly Korda", sport: "⛳", era: "modern" },
  // Classic
  { name: "Jack Nicklaus", sport: "⛳", era: "classic" },
  { name: "Tom Watson", sport: "⛳", era: "classic" },
  { name: "Nick Faldo", sport: "⛳", era: "classic" },
  { name: "Greg Norman", sport: "⛳", era: "classic" },
  { name: "Seve Ballesteros", sport: "⛳", era: "classic" },
  { name: "Lee Trevino", sport: "⛳", era: "classic" },
  { name: "Curtis Strange", sport: "⛳", era: "classic" },
  { name: "Payne Stewart", sport: "⛳", era: "classic" },
  { name: "Bernhard Langer", sport: "⛳", era: "classic" },
  { name: "Sandy Lyle", sport: "⛳", era: "classic" },
  { name: "Ian Woosnam", sport: "⛳", era: "classic" },
  { name: "Mark Calcavecchia", sport: "⛳", era: "classic" },
  { name: "Paul Azinger", sport: "⛳", era: "classic" },
  { name: "Corey Pavin", sport: "⛳", era: "classic" },
  { name: "Mark O'Meara", sport: "⛳", era: "classic" },
  { name: "Fred Couples", sport: "⛳", era: "classic" },
  { name: "Davis Love III", sport: "⛳", era: "classic" },
  { name: "Hal Sutton", sport: "⛳", era: "classic" },
  { name: "Bob Tway", sport: "⛳", era: "classic" },
  { name: "Larry Mize", sport: "⛳", era: "classic" },
  // Legends
  { name: "Ben Hogan", sport: "⛳", era: "legends" },
  { name: "Sam Snead", sport: "⛳", era: "legends" },
  { name: "Byron Nelson", sport: "⛳", era: "legends" },
  { name: "Arnold Palmer", sport: "⛳", era: "legends" },
  { name: "Gary Player", sport: "⛳", era: "legends" },
  { name: "Billy Casper", sport: "⛳", era: "legends" },
  { name: "Gene Sarazen", sport: "⛳", era: "legends" },
  { name: "Walter Hagen", sport: "⛳", era: "legends" },
  { name: "Bobby Jones", sport: "⛳", era: "legends" },
  { name: "Tony Lema", sport: "⛳", era: "legends" },
  { name: "Julius Boros", sport: "⛳", era: "legends" },
  { name: "Bob Charles", sport: "⛳", era: "legends" },
  { name: "Roberto De Vicenzo", sport: "⛳", era: "legends" },
  { name: "Doug Sanders", sport: "⛳", era: "legends" },
  { name: "Tom Weiskopf", sport: "⛳", era: "legends" },

  // ─── HOCKEY (NHL) ────────────────────────────────────────────────────────────
  // Modern
  { name: "Wayne Gretzky", sport: "🏒", era: "classic" },
  { name: "Sidney Crosby", sport: "🏒", era: "modern" },
  { name: "Alexander Ovechkin", sport: "🏒", era: "modern" },
  { name: "Connor McDavid", sport: "🏒", era: "modern" },
  { name: "Nathan MacKinnon", sport: "🏒", era: "modern" },
  { name: "Nikita Kucherov", sport: "🏒", era: "modern" },
  { name: "Erik Karlsson", sport: "🏒", era: "modern" },
  { name: "Auston Matthews", sport: "🏒", era: "modern" },
  { name: "Connor Bedard", sport: "🏒", era: "modern" },
  { name: "Leon Draisaitl", sport: "🏒", era: "modern" },
  { name: "David Pastrnak", sport: "🏒", era: "modern" },
  { name: "Mikko Rantanen", sport: "🏒", era: "modern" },
  { name: "Cale Makar", sport: "🏒", era: "modern" },
  { name: "Victor Hedman", sport: "🏒", era: "modern" },
  { name: "Andrei Vasilevskiy", sport: "🏒", era: "modern" },
  { name: "Jonathan Toews", sport: "🏒", era: "modern" },
  { name: "Patrick Kane", sport: "🏒", era: "modern" },
  { name: "Henrik Lundqvist", sport: "🏒", era: "modern" },
  { name: "Martin Brodeur", sport: "🏒", era: "modern" },
  { name: "Evgeni Malkin", sport: "🏒", era: "modern" },
  { name: "Nicklas Backstrom", sport: "🏒", era: "modern" },
  { name: "Henrik Zetterberg", sport: "🏒", era: "modern" },
  { name: "Pavel Datsyuk", sport: "🏒", era: "modern" },
  { name: "Joe Thornton", sport: "🏒", era: "modern" },
  { name: "Jarome Iginla", sport: "🏒", era: "modern" },
  { name: "Mats Sundin", sport: "🏒", era: "modern" },
  { name: "Brendan Shanahan", sport: "🏒", era: "modern" },
  { name: "Scott Niederma yer", sport: "🏒", era: "modern" },
  { name: "Chris Chelios", sport: "🏒", era: "modern" },
  { name: "Nicklas Lidstrom", sport: "🏒", era: "modern" },
  { name: "Rob Blake", sport: "🏒", era: "modern" },
  { name: "Al MacInnis", sport: "🏒", era: "modern" },
  // Classic
  { name: "Mario Lemieux", sport: "🏒", era: "classic" },
  { name: "Mark Messier", sport: "🏒", era: "classic" },
  { name: "Jaromir Jagr", sport: "🏒", era: "classic" },
  { name: "Steve Yzerman", sport: "🏒", era: "classic" },
  { name: "Brett Hull", sport: "🏒", era: "classic" },
  { name: "Paul Coffey", sport: "🏒", era: "classic" },
  { name: "Mike Bossy", sport: "🏒", era: "classic" },
  { name: "Denis Savard", sport: "🏒", era: "classic" },
  { name: "Peter Bondra", sport: "🏒", era: "classic" },
  { name: "Cam Neely", sport: "🏒", era: "classic" },
  { name: "Mike Vernon", sport: "🏒", era: "classic" },
  { name: "Patrick Roy", sport: "🏒", era: "classic" },
  { name: "Ray Bourque", sport: "🏒", era: "classic" },
  { name: "Guy Lafleur", sport: "🏒", era: "classic" },
  { name: "Teemu Selanne", sport: "🏒", era: "classic" },
  { name: "Luc Robitaille", sport: "🏒", era: "classic" },
  { name: "Joe Nieuwendyk", sport: "🏒", era: "classic" },
  { name: "Pat LaFontaine", sport: "🏒", era: "classic" },
  { name: "Pierre Turgeon", sport: "🏒", era: "classic" },
  { name: "Dale Hawerchuk", sport: "🏒", era: "classic" },
  { name: "Mike Gartner", sport: "🏒", era: "classic" },
  { name: "Lanny McDonald", sport: "🏒", era: "classic" },
  { name: "Bryan Trottier", sport: "🏒", era: "classic" },
  { name: "Denis Potvin", sport: "🏒", era: "classic" },
  { name: "Clark Gillies", sport: "🏒", era: "classic" },
  { name: "Bob Nystrom", sport: "🏒", era: "classic" },
  { name: "Larry Robinson", sport: "🏒", era: "classic" },
  { name: "Ken Dryden", sport: "🏒", era: "classic" },
  { name: "Yvan Cournoyer", sport: "🏒", era: "classic" },
  { name: "Steve Shutt", sport: "🏒", era: "classic" },
  { name: "Larry Murphy", sport: "🏒", era: "classic" },
  // Legends
  { name: "Bobby Orr", sport: "🏒", era: "legends" },
  { name: "Gordie Howe", sport: "🏒", era: "legends" },
  { name: "Phil Esposito", sport: "🏒", era: "legends" },
  { name: "Bobby Hull", sport: "🏒", era: "legends" },
  { name: "Stan Mikita", sport: "🏒", era: "legends" },
  { name: "Frank Mahovlich", sport: "🏒", era: "legends" },
  { name: "Jean Beliveau", sport: "🏒", era: "legends" },
  { name: "Maurice Richard", sport: "🏒", era: "legends" },
  { name: "Henri Richard", sport: "🏒", era: "legends" },
  { name: "Johnny Bower", sport: "🏒", era: "legends" },
  { name: "Terry Sawchuk", sport: "🏒", era: "legends" },
  { name: "Glenn Hall", sport: "🏒", era: "legends" },
  { name: "Jacques Plante", sport: "🏒", era: "legends" },
  { name: "Tim Horton", sport: "🏒", era: "legends" },
  { name: "Red Kelly", sport: "🏒", era: "legends" },
  { name: "Norm Ullman", sport: "🏒", era: "legends" },
  { name: "Alex Delvecchio", sport: "🏒", era: "legends" },
  { name: "Ted Lindsay", sport: "🏒", era: "legends" },
  { name: "Sid Abel", sport: "🏒", era: "legends" },
  { name: "Milt Schmidt", sport: "🏒", era: "legends" },
];
...
export default function StatsIQ() {
  ...
  // Filter athletes for autocomplete based on input, sport filter, and era filter
  const suggestions = input.trim().length >= 2 ? ATHLETES.filter(a => {
    const matchesText = a.name.toLowerCase().includes(input.toLowerCase());
    const matchesSport = filter.size === 0 || filter.has(a.sport);
    const matchesEra = eraFilter.size === 0 || eraFilter.has(a.era);
    return matchesText && matchesSport && matchesEra;
  }).sort((a, b) => {
    // Prioritize names that start with the input
    const aStarts = a.name.toLowerCase().startsWith(input.toLowerCase());
    const bStarts = b.name.toLowerCase().startsWith(input.toLowerCase());
  ...
  const submit = useCallback((overrideName?: string) => {
    const g = (overrideName || input).trim();
          ...
          <div style={{ position:"relative" }}>
            <div style={{ display:"flex", gap:8 }}>
              <input
                ...
                onKeyDown={e => {
                  if (e.key === "Enter" && input.trim().length >= 3) { setShowSuggestions(false); submit(); }
                  if (e.key === "Escape") setShowSuggestions(false);
                  if (e.key === "ArrowDown") { e.preventDefault(); setSelectedSuggestion(s => Math.min(s + 1, suggestions.length - 1)); }
                  if (e.key === "ArrowUp") { e.preventDefault(); setSelectedSuggestion(s => Math.max(s - 1, 0)); }
                  if (e.key === "Tab" && suggestions.length > 0) { e.preventDefault(); setInput(suggestions[selectedSuggestion]?.name || input); setShowSuggestions(false); }
                }}
                onFocus={e => { setShowSuggestions(true); setTimeout(() => e.target.scrollIntoView({ behavior:"smooth", block:"center" }), 300); }}
            ...
            {showSuggestions && suggestions.length > 0 && (
              <div style={{ position:"absolute", top:"calc(100% + 4px)", left:0, right:60, background:"#0f1629", border:`1px solid ${cfg.border}`, borderRadius:10, zIndex:50, maxHeight:200, overflowY:"auto", boxShadow:"0 8px 32px rgba(0,0,0,0.5)" }}>
                {suggestions.slice(0, 8).map((a, i) => (
                  <div
                    key={a.name}
                    onMouseDown={() => { setInput(a.name); setShowSuggestions(false); setTimeout(() => submit(a.name), 50); }}
                    style={{ padding:"10px 14px", cursor:"pointer", background: i === selectedSuggestion ? `${cfg.bg}` : "transparent", borderBottom:"1px solid rgba(255,255,255,0.05)", display:"flex", alignItems:"center", gap:10, transition:"background 0.1s" }}
                  >
                    <span style={{ fontSize:"0.85rem" }}>{a.sport}</span>
                    <span style={{ color: i === selectedSuggestion ? cfg.color : "#d1d5db", fontSize:"0.88rem", flex:1 }}>{a.name}</span>
                    <span style={{ fontSize:"0.6rem", color:"#4b5563" }}>{a.era}</span>
                  </div>
                ))}
              </div>
            )}
