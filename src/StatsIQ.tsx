...
const MEDIUM = [
  ...
  { player:"Milt Pappas", sport:"⚾ MLB", answer:"MILT PAPPAS", era:"classic", stats:{W:"209",NH:"1972",CLOSE:"Called 3-0 on 27th",ERA:"3.40"}, ctx:"Career Totals — Came within one strike of a perfect game in 1972", clues:["Threw a no-hitter in 1972 but missed a perfect game when the umpire called ball four on a 3-0 count with two outs in the 9th","Won 209 career games for four different teams","Was traded for Frank Robinson — one of the most lopsided trades in MLB history","From Detroit Michigan — played his best years with the Baltimore Orioles"] },
];
...
const HARD = [
  ...
  { player:"Saddiq Bey", sport:"🏀 NBA", answer:"SADDIQ BEY", era:"modern", stats:{PPG:"16.1",THREE:"3.3 per game",TEAM:"Pistons",YEAR:"2021-22"}, ctx:"2021-22 NBA Season — Detroit Pistons emerging scorer", clues:["Averaged 16.1 points per game for the Detroit Pistons in 2021-22","Shot over three three-pointers per game — one of the most accurate in the league","Was a key piece of Detroit's rebuilding process","From Washington DC — played at Villanova before being drafted 19th overall"] },
