...
const HARD = [
  ...
  { player:"Bob Boozer", sport:"🏀 NBA", answer:"BOB BOOZER HARD", era:"classic", stats:{PTS:"14.8",REB:"9.3",GOLD:"1960 Olympics",TEAM:"Knicks/Lakers"}, ctx:"Career Totals — Olympic gold medalist who had a quiet NBA career", clues:["Won a gold medal with the United States at the 1960 Rome Olympics","Averaged 14.8 points and 9.3 rebounds per game for his career","Was selected to multiple All-Star games during the 1960s","From Omaha Nebraska — played at Kansas State before being drafted by the Cincinnati Royals"] },
  ...
  { player:"Connie Hawkins", sport:"🏀 NBA", answer:"CONNIE HAWKINS HARD", era:"classic", stats:{PTS:"18.7",ALLSTAR:"4x",BANNED:"Wrongly excluded",TEAM:"Suns"}, ctx:"Career Totals — Wrongly banned from the NBA for years then vindicated", clues:["Was wrongly banned from the NBA for alleged ties to gamblers before being reinstated and winning a lawsuit","Averaged 18.7 points per game in the NBA after being kept out during his prime years","Dominated the ABA before finally joining the NBA at age 26","From Brooklyn New York — was considered one of the most gifted players of his generation"] },
  ...
  { player:"Karl-Heinz Rummenigge Classic", sport:"⚽ Soccer", answer:"RUMMENIGGE CLASSIC_2", era:"classic", stats:{BALLON:"2",CONSECUTIVE:"1980-81",GERMANY:"WC Final 1982",CLUB:"Bayern Munich"}, ctx:"Career Totals — Won Ballon d Or twice and led Germany to World Cup Final", clues:["Won 2 consecutive Ballon d Or awards in 1980 and 1981","Led West Germany to the World Cup Final in 1982 despite being injured","Was one of the most accomplished players of their generation","From Lippe Germany — later became the long-serving CEO of Bayern Munich"] },
  ...
  { player:"Ken Dryden Classic", sport:"🏒 NHL", answer:"KEN DRYDEN CLASSIC", era:"classic", stats:{CUPS:"6",VEZINA:"5",RETIRE:"Age 31",LAWYER:"Cornell"}, ctx:"Career Totals — Six Cups and five Vezinas before retiring at 31 to practice law", clues:["Won 6 Stanley Cups and 5 Vezina Trophies in just 8 NHL seasons","Retired at age 31 to practice law — leaving the game at the height of his powers","Was a Cornell University graduate who passed the bar exam during his hockey career","Was one of the most accomplished players of their generation"] },
