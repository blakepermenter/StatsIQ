...
const EASY = [
  ...
  { player:"Patrick Mahomes", sport:"🏈 NFL", answer:"MAHOMES", era:"modern", stats:{YDS:"360",TD:"3",INT:"0",COMP:"21"}, ctx:"Super Bowl LVII MVP vs Philadelphia Eagles", clues:["Was known for extending broken plays with his legs and arm in ways no quarterback had done before","Became the highest-paid player in NFL history when he signed his contract extension in 2020","His father Patrick Mahomes Sr. pitched in Major League Baseball for 11 seasons","Won his second Super Bowl"] },
  ...
  { player:"Peyton Manning", sport:"🏈 NFL", answer:"MANNING", era:"modern", stats:{YDS:"5477",TD:"55",INT:"10",RTG:"115.1"}, ctx:"2013 NFL Season — Single season TD record", clues:["Retired with the most passing yards in NFL history at the time","Known for his meticulous pre-snap audibles and his legendary ability to read and diagnose defenses at the line of scrimmage","Was known for his pre-snap theatrics and audible calls that confused opposing defenses","Brother Eli also played QB in NFL"] },
  ...
  { player:"Shohei Ohtani", sport:"⚾ MLB", answer:"OHTANI", era:"modern", stats:{HR:"171",ERA:"2.91",SB:"50",MVP:"2"}, ctx:"Career through 2024 — The two-way phenomenon", clues:["Has won 2 AL MVP awards as both a pitcher AND hitter","Hit 50 home runs and stole 50 bases in the 2024 season — becoming the first player in MLB history to do so","First player since Babe Ruth to be an elite starter AND elite hitter in the same season","Won AL MVP in 2021 with 46 HRs and a 3.18 ERA — the first unanimous two-way MVP"] },
  ...
  { player:"Elvin Hayes", sport:"🏀 NBA", answer:"HAYES", era:"classic", stats:{PTS:"28.4",REB:"17.1",BLK:"3.7",FG:"42.5"}, ctx:"1970-71 NBA Season — San Diego Rockets scoring leader", clues:["Led the NBA in rebounds this season","From Rayville Louisiana — was selected first overall in the 1968 NBA Draft by the San Diego Rockets","Nicknamed The Big E","Won the NBA championship with Washington in 1978"] },
  ...
  { player:"Ilie Nastase", sport:"🎾 ATP", answer:"NASTASE", era:"classic", stats:{W:"104",L:"7",GRAND_SLAMS:"2",WORLD_NO1:"Yes"}, ctx:"1973 ATP Season — World No. 1 dominant year", clues:["Was the first official World No. 1 in tennis","Won 2 Grand Slams in his career","Romanian player known as Nasty for his on-court behavior","Won over 60 singles titles — one of only a handful of players ever to win 100 or more combined singles and doubles titles"] },
  ...
  { player:"Walter Hagen", sport:"⛳ Golf", answer:"WALTER HAGEN", era:"legends", stats:{MAJORS:"11",PGA:"5",BRIT:"4",YEAR:"1928"}, ctx:"Career — 1920s dominant era", clues:["Won 11 major championships in his career","Won 4 consecutive PGA Championships from 1924 to 1927 — 5 total — a record that still stands","Was the first golfer to earn $1 million","Was famous for his showmanship and stylish appearance"] },
...
const MEDIUM = [
  ...
  { player:"Gary Carter", sport:"⚾ MLB", answer:"GARY", era:"classic", stats:{HR:"32",AVG:".281",RBI:"106",GG:"3"}, ctx:"Career Peak — Montreal Expos catcher before joining the Mets", clues:["Won 3 Gold Gloves in his career","Was traded from the Expos to the Mets after the 1984 season — his last year with Montreal","His 1986 World Series performance with the Mets was iconic","Nicknamed The Kid"] },
...
const HARD = [
  ...
  { player:"Bob Boozer", sport:"🏀 NBA", answer:"BOB BOOZER_2", era:"classic", stats:{PTS:"14.8",REB:"9.3",GOLD:"1960 Olympics",TEAM:"Knicks/Lakers"}, ctx:"Career Totals — Olympic gold medalist who had a quiet NBA career", clues:["Won a gold medal with the United States at the 1960 Rome Olympics","Averaged 14.8 points and 9.3 rebounds per game for his career","Was selected to multiple All-Star games during the 1960s","From Omaha Nebraska — played at Kansas State before being drafted by the Cincinnati Royals"] },
  ...
  { player:"Connie Hawkins", sport:"🏀 NBA", answer:"CONNIE HAWKINS_2", era:"classic", stats:{PTS:"18.7",ALLSTAR:"4x",BANNED:"Wrongly excluded",TEAM:"Suns"}, ctx:"Career Totals — Wrongly banned from the NBA for years then vindicated", clues:["Was wrongly banned from the NBA for alleged ties to gamblers before being reinstated and winning a lawsuit","Averaged 18.7 points per game in the NBA after being kept out during his prime years","Dominated the ABA before finally joining the NBA at age 26","From Brooklyn New York — was considered one of the most gifted players of his generation"] },
  ...
  { player:"Bebeto", sport:"⚽ Soccer", answer:"BEBETO 2", era:"classic", stats:{G:"3",APP:"7",MIN:"630",YEAR:"1994"}, ctx:"1994 FIFA World Cup — Brazil champion", clues:["Was one of the most accomplished players of their generation","Was the perfect foil for Romario's creativity","Scored 3 goals during this tournament or season","Famous for his baby-rocking goal celebration after his son was born during the tournament"] },
  ...
  { player:"Karl-Heinz Rummenigge", sport:"⚽ Soccer", answer:"RUMMENIGGE_2", era:"classic", stats:{G:"5",APP:"7",MIN:"614",YEAR:"1982"}, ctx:"1982 FIFA World Cup — West Germany finalist", clues:["Led West Germany to the World Cup Final","Won 2 consecutive Ballon d'Or awards (1980 and 1981)","Bayern Munich have won the Bundesliga more times than any other German club","West Germany lost the 1982 Final to Italy in extra time"] },
  ...
  { player:"Zico", sport:"⚽ Soccer", answer:"ZICO", era:"classic", stats:{G:"52",NATION:"Brazil",FREE_KICK:"Master",BALLON:"Runner up"}, ctx:"Career Totals — The White Pele who led Brazil through the 1970s and 80s", clues:["Was nicknamed The White Pele for his extraordinary skill and goal-scoring ability","Led Brazil's most entertaining World Cup teams in 1982 and 1986 — neither won the trophy","Scored 52 goals in 71 appearances for Brazil — a remarkable ratio","From Rio de Janeiro Brazil — later became a successful coach in Japan"] },
  { player:"Marco van Basten", sport:"⚽ Soccer", answer:"MARCO VAN BASTEN", era:"classic", stats:{BALLON:"3",EURO:"1988 volley",ANKLE:"Career ending at 28",TEAM:"AC Milan"}, ctx:"Career Totals — Three Ballons d Or before his ankle ended his career at 28", clues:["Won 3 Ballon d Or awards and had his career destroyed by a chronic ankle injury at just 28","Scored what many consider the greatest goal in European Championship history — a stunning volley in the 1988 final","Won 3 Serie A titles and 2 European Cups with AC Milan","From Utrecht Netherlands — coached the Dutch national team after retirement"] },
  { player:"Ruud Gullit", sport:"⚽ Soccer", answer:"RUUD GULLIT", era:"classic", stats:{BALLON:"1987",EURO:"1988",MILAN:"Dynasty",DREADLOCKS:"Famous"}, ctx:"Career Totals — Ballon d Or winner and heart of the Dutch golden generation", clues:["Won the Ballon d Or in 1987 and the European Championship with the Netherlands in 1988","Was the creative force alongside Van Basten and Rijkaard in the great AC Milan side","Was the first Black player to win the Ballon d Or","Dedicated his 1987 Ballon d Or to Nelson Mandela who was still imprisoned at the time"] },
  { player:"Frank Rijkaard", sport:"⚽ Soccer", answer:"FRANK RIJKAARD", era:"classic", stats:{UCL:"2",EURO:"1988",MILAN:"Dynasty",SPIT:"Famous incident"}, ctx:"Career Totals — Won two European Cups and the European Championship", clues:["Won 2 European Cups with AC Milan alongside Van Basten and Gullit","Won the European Championship with the Netherlands in 1988","Was involved in a famous spitting incident with Rudi Voller at the 1990 World Cup","From Amsterdam Netherlands — later successfully managed Barcelona to 2 La Liga titles"] },
  { player:"George Best", sport:"⚽ Soccer", answer:"GEORGE BEST", era:"classic", stats:{BALLON:"1968",GOALS:"137",BOOTS:"Beatles of football",TEAM:"Manchester United"}, ctx:"Career Totals — 1968 Ballon d Or and the fifth Beatle at Old Trafford", clues:["Won the Ballon d Or in 1968 and was nicknamed the Fifth Beatle for his celebrity status","Scored 137 goals in 361 appearances for Manchester United","Famously said he spent most of his money on birds booze and fast cars — the rest he wasted","From Belfast Northern Ireland — struggled with alcoholism which cut short his peak years"] },

  // HARD Soccer Legends (need 13 more)
  { player:"Eusebio", sport:"⚽ Soccer", answer:"EUSEBIO", era:"legends", stats:{G:"9",WC:"1966 bronze",BALLON:"1965",NATION:"Mozambique-Portugal"}, ctx:"Career Totals", clues:["Won the Ballon d Or in 1965 and the Golden Boot at the 1966 World Cup with 9 goals","Led Portugal to third place at the 1966 World Cup — still their best ever finish","From Lourenco Marques Mozambique — represented Portugal in an era when colonial ties allowed this","Was nicknamed The Black Panther and is considered the greatest Portuguese player before Ronaldo"] },
  ...
  { player:"Ken Rosewall", sport:"🎾 ATP", answer:"KEN ROSEWALL", era:"legends", stats:{GRAND_SLAMS:"8",SPAN:"1953-1972",NICK:"Muscles",AGE:"39 finalist"}, ctx:"Career Totals — The Muscles from Muscles from Melbourne who never turned pro", clues:["Won his first Grand Slam in 1953 and his last in 1972 — 19 years apart across three decades","Reached the Wimbledon final at age 39 — one of the most extraordinary feats in the sport","Was nicknamed Muscles despite weighing only 150 pounds","From Sydney Australia — was considered technically perfect"] },
  { player:"Rod Laver", sport:"🎾 ATP", answer:"ROD LAVER", era:"legends", stats:{CALENDAR_SLAM:"2",GRAND_SLAMS:"11",OPEN_ERA:"Dominant",ROCKET:"Nickname"}, ctx:"Career Totals", clues:["Is the only player in history to win the Calendar Grand Slam twice — 1962 and 1969","Won 11 Grand Slam titles in the Open Era alone","Was banned from Wimbledon for years because he had turned professional","From Rockhampton Queensland Australia — the ATP Finals arena Rod Laver Arena bears his name"] },
  { player:"Roy Emerson", sport:"🎾 ATP", answer:"ROY EMERSON", era:"legends", stats:{GRAND_SLAMS:"12",AUS_OPEN:"6x",FITNESS:"Best ever",NATION:"Australia"}, ctx:"Career Totals — 12 Grand Slams and extraordinary fitness", clues:["Won 12 Grand Slam titles — the most in history before Pete Sampras","Was so physically fit that opponents said it was exhausting just watching him train","Won the Australian Open 6 times","From Blackbutt Queensland Australia — held the Grand Slam singles record for over 30 years"] },
  ...
  { player:"Andy Murray", sport:"🎾 ATP", answer:"ANDY MURRAY_2", era:"modern", stats:{SLAMS:"3",OLYMPIC:"Gold x2",HIP:"Surgery",NATION:"UK"}, ctx:"Career Totals — Britain's greatest tennis player fought back from career-ending hip surgery", clues:["Won 3 Grand Slam titles and became the first British man to win Wimbledon in 77 years","Won Olympic gold in singles twice — 2012 and 2016 — a unique achievement","Returned from hip resurfacing surgery that many believed had ended his career","From Dunblane Scotland — survived the Dunblane school shooting as a child"] },
  { player:"Stan Wawrinka", sport:"🎾 ATP", answer:"STAN WAWRINKA_3", era:"modern", stats:{SLAMS:"3",UPSETS:"Djokovic Federer Nadal",NATION:"Switzerland",BACK:"Injuries"}, ctx:"Career Totals — Won three Slams as the giant killer", clues:["Won 3 Grand Slam titles — beating Djokovic Federer or Nadal in each final","Is one of only three men in the Open Era to win three Slams outside the Big Four era","Had one of the most devastating single-handed backhands ever seen","From Lausanne Switzerland — his compatriot Roger Federer called him a great champion"] },
  { player:"Dominic Thiem", sport:"🎾 ATP", answer:"DOMINIC THIEM_2", era:"modern", stats:{SLAM:"2020 US Open",FINALS:"3",NATION:"Austria",COMEBACK:"Wrist"}, ctx:"Career Totals — Austria's first Grand Slam champion", clues:["Won the 2020 US Open — the first Austrian man to win a Grand Slam","Was one of the most accomplished players of their generation","Overcame a serious wrist injury that kept him out for almost an entire year","From Wiener Neustadt Austria — learned the game from his father Wolfgang who is also a tennis coach"] },

  // MEDIUM Golf Modern (need 1)
...
{ player:"Clyde Lovellette", sport:"🏀 NBA", answer:"CLYDE LOVELLETTE", era:"legends", stats:{RINGS:"3",ALLSTAR:"3x",PTS:"17.0",TEAM:"Lakers/Celtics"}, ctx:"Career Totals — Won championships on both the Lakers and Celtics dynasties", clues:["Is one of only a handful of players to win NBA championships with both the Minneapolis Lakers and Boston Celtics","Made three All-Star teams as a reliable scoring big man in the 1950s","Won an NCAA title at Kansas before also winning Olympic gold and then NBA titles","From Terre Haute Indiana — played at Kansas under Phog Allen before being drafted by Minneapolis"] },
  { player:"Larry Foust", sport:"🏀 NBA", answer:"LARRY FOUST", era:"legends", stats:{ALLSTAR:"8x",PTS:"13.7",REB:"9.8",TEAM:"Pistons/Hawks"}, ctx:"Career Totals — Eight-time All-Star who was one of the best centers of the early 1950s", clues:["Made eight All-Star teams as one of the premier centers of the early NBA era","Spent his best years with the Fort Wayne Pistons before the franchise relocated to Detroit","Was considered one of the more physical and skilled big men of his generation","From Painesville Ohio — played at La Salle before being drafted by Fort Wayne in 1950"] },
{ player:"Dino Zoff", sport:"⚽ Soccer", answer:"DINO ZOFF", era:"classic", stats:{CAPS:"112",WC:"1982",CLUB:"Juventus",AGE:"40 in WC final"}, ctx:"1982 FIFA World Cup — Italy goalkeeper who won the title at age 40", clues:["Was 40 years old when he captained Italy to the 1982 World Cup title in Spain — the oldest ever World Cup winner","Kept a clean sheet for 1142 consecutive international minutes — a world record","Made 112 appearances for Italy over 16 years","From Mariano del Friuli Italy — spent most of his club career at Juventus"] },
  { player:"Cy Denneny", sport:"🏒 NHL", answer:"CY DENNENY", era:"legends", stats:{GOALS:"246",CUPS:"5",TEAM:"Senators/Bruins",ERA:"Original Six pioneer"}, ctx:"Career Totals — One of the most prolific scorers of the early NHL era", clues:["Was one of the most feared scorers in the early NHL during the 1920s","Won five Stanley Cup championships across his career","Scored 246 goals in an era when scoring was much more difficult","From Farran Point Ontario — was a pioneer of the professional game in its earliest years"] },
  ...
  { player:"Georges Vezina", sport:"🏒 NHL", answer:"GEORGES VEZINA", era:"legends", stats:{TROPHY:"Named after him",CUPS:"2",TEAM:"Canadiens",ERA:"1910s-20s"}, ctx:"Career Totals — The Chicoutimi Cucumber whose name graces the goaltending trophy", clues:["The NHL goaltending trophy — the Vezina Trophy — is named in his honor","Was nicknamed the Chicoutimi Cucumber for his cool demeanor under pressure","Never missed a game in his entire NHL career until his final season","From Chicoutimi Quebec — played his entire career with the Montreal Canadiens"] },

  { player:"Dino Zoff", sport:"⚽ Soccer", answer:"DINO ZOFF", era:"classic", stats:{CAPS:"112",WC:"1982",CLUB:"Juventus",AGE:"40 in WC final"}, ctx:"1982 FIFA World Cup — Italy goalkeeper who won the title at age 40", clues:["Was 40 years old when he captained Italy to the 1982 World Cup title — the oldest ever World Cup winner","Kept a clean sheet for 1142 consecutive international minutes — a world record","Made 112 appearances for Italy over 16 years","From Mariano del Friuli Italy — spent most of his club career at Juventus"] },
  ...
  { player:"Gary Lineker", sport:"⚽ Soccer", answer:"GARY LINEKER", era:"classic", stats:{WC_GOALS:"6",ENGLAND:"48 goals",CLUB:"Tottenham/Barcelona",TROPHY:"Golden Boot 1986"}, ctx:"1986 World Cup — Won the Golden Boot with 6 goals for England", clues:["Won the Golden Boot at the 1986 World Cup with six goals including a hat-trick against Poland","Scored 48 international goals for England — second most in history at the time of retirement","Never received a yellow or red card in his entire professional career","From Leicester England — played for Leicester Tottenham Barcelona and Japan's Nagoya Grampus Eight"] },
  { player:"Ken Dryden", sport:"🏒 NHL", answer:"KEN DRYDEN", era:"classic", stats:{CUPS:"6",VEZINA:"5x",GAA:"2.24",TEAM:"Canadiens"}, ctx:"Career Totals — Won 6 Stanley Cups in just 8 seasons with the Montreal Canadiens", clues:["Won six Stanley Cup championships in just eight NHL seasons — one of the greatest winning percentages ever","Won the Vezina Trophy five times as the NHL top goaltender","Had a career goals against average of 2.24 — elite even by modern standards","From Hamilton Ontario — attended Cornell University and joined the Canadiens late after law school"] },
