...
const MEDIUM = [
  ...
  { player:"Goran Ivanisevic", sport:"🎾 ATP", answer:"GORAN IVANISEVIC", era:"modern", stats:{WIMBLEDON:"1x winner",WILDCARD:"2001",RANK:"125",YEAR:"2001"}, ctx:"2001 Wimbledon — Won as a wildcard ranked No. 125", clues:["Won Wimbledon as a wildcard when ranked No. 125 in the world","Was the first and only wildcard entry to win Wimbledon","From Split Croatia","Had a famous alter ego Goran who played more aggressively"] },
