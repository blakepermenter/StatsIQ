...
const MEDIUM = [
  ...
  { player:"Fred Taylor", sport:"🏈 NFL", answer:"FRED TAYLOR", era:"modern", stats:{RUSH:"11695",TD:"66",TEAM:"Jaguars",NICK:"Fragile Fred"}, ctx:"Career Totals — Elite runner whose injuries prevented him from reaching all-time status", clues:["Was nicknamed Fragile Fred because his career was constantly interrupted by injuries","Finished with nearly 12000 career rushing yards despite missing significant time","Was considered one of the most talented pure runners of his era when healthy","From Belle Glade Florida — played at Florida before being drafted 9th overall by Jacksonville in 1998"] },
  ...
  { player:"Caroline Wozniacki", sport:"🎾 WTA", answer:"WOZNIACKI", era:"modern", stats:{W:"74",L:"17",TITLES:"9",WEEKS_NO1:"101"}, ctx:"2010 WTA Season — World No. 1", clues:["Reached World No. 1 for the first time in her career","Won 9 titles this season including the US Open Series","Danish player who was known for her consistency","Later won her only Grand Slam at the 2018 Australian Open"] },
  { player:"Jennifer Capriati", sport:"🎾 ATP", answer:"CAPRIATI", era:"modern", stats:{W:"62",L:"16",GRAND_SLAMS:"3",WEEKS_NO1:"101"}, ctx:"2001 WTA Season — World No. 1 comeback", clues:["Made one of the greatest comebacks in tennis history","Won the Australian Open and French Open this year","Had struggled with personal problems before this comeback","Was a child prodigy who turned pro at age 13"] },
  ...
  { player:"Martina Hingis", sport:"🎾 WTA", answer:"MARTINA HINGIS", era:"modern", stats:{GRAND_SLAMS:"5",WEEKS_NO1:"101",AGE:"16",YEAR:"1997"}, ctx:"Career Totals — Youngest World No. 1 in history at age 16", clues:["Won 5 Grand Slam singles titles","Was the youngest player to reach World No. 1 at age 16","From Kosice Czechoslovakia but representing Switzerland","Was named after Martina Navratilova by her tennis-playing mother"] },
...
{ player:"Fat Lever", sport:"🏀 NBA", answer:"FAT LEVER", era:"classic", stats:{AST:"7.5",REB:"7.5",ALLSTAR:"2x",TEAM:"Nuggets"}, ctx:"Career Totals — One of the first point-forwards and a triple-double machine in Denver", clues:["Was one of the few guards in NBA history to average 7+ assists AND 7+ rebounds per game","Had his career ended prematurely by a serious knee injury in 1990","Made two All-Star teams with the Denver Nuggets in the mid-1980s","Born Lafayette Lever in Pine Bluff Arkansas — nickname Fat came from childhood"] },
  ...
  { player:"Vern Mikkelsen", sport:"🏀 NBA", answer:"VERN MIKKELSEN", era:"legends", stats:{RINGS:"4",ALLSTAR:"6x",FOULS:"First to foul out of 6 games in season",TEAM:"Lakers"}, ctx:"Career Totals — Won four NBA championships as part of the Minneapolis Lakers dynasty", clues:["Won four NBA championships with the Minneapolis Lakers dynasty in the early 1950s","Made six All-Star teams as one of the toughest interior players of his era","Was the first player in NBA history to foul out of six games in a single season","From Askov Minnesota — played at Hamline before being drafted by Minneapolis in 1949"] },
...
{ player:"Clyde Lovellette", sport:"🏀 NBA", answer:"CLYDE LOVELLETTE", era:"legends", stats:{RINGS:"3",ALLSTAR:"3x",PTS:"17.0",TEAM:"Lakers/Celtics"}, ctx:"Career Totals — Rare player who won rings with both the Lakers and Celtics dynasties", clues:["Is one of only a handful of players to win NBA championships with both the Minneapolis Lakers and Boston Celtics","Made three All-Star teams as a reliable scoring big man in the 1950s","Won an NCAA title at Kansas before also winning Olympic gold and then NBA titles","From Terre Haute Indiana — played at Kansas under Phog Allen before being drafted by Minneapolis"] },
  ...
  { player:"Georges Vezina", sport:"🏒 NHL", answer:"GEORGES VEZINA", era:"legends", stats:{TROPHY:"Named after him",CUPS:"2",TEAM:"Canadiens",ERA:"1910s-20s"}, ctx:"Career Totals — The Chicoutimi Cucumber — the NHL goaltending trophy bears his name", clues:["The NHL goaltending trophy — the Vezina Trophy — is named in his honor","Was nicknamed the Chicoutimi Cucumber for his cool demeanor under pressure","Never missed a game in his entire NHL career until his final season","From Chicoutimi Quebec — played his entire career with the Montreal Canadiens"] },
...
{ player:"Gunnar Gren", sport:"⚽ Soccer", answer:"GUNNAR GREN", era:"legends", stats:{TEAM:"AC Milan",NATION:"Sweden",WC:"1958 runner-up",TRIO:"Gre-No-Li at Milan"}, ctx:"Career Totals — Part of the legendary Gre-No-Li trio at AC Milan", clues:["Was part of the legendary Gre-No-Li trio at AC Milan alongside Gunnar Nordahl and Nils Liedholm","Helped Sweden reach the 1958 World Cup final on home soil where they lost to Brazil","Was considered one of the most technically gifted Swedish players ever","From Gothenburg Sweden — played at IFK Goteborg before becoming a star in Serie A"] },
