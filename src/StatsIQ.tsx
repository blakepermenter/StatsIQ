...
const EASY = [
  ...
  // Hockey - Modern
  { player:"Connor McDavid", sport:"🏒 NHL", answer:"MCDAVID", era:"modern", stats:{G:"44",AST:"79",PTS:"123",PIM:"44"}, ctx:"2021-22 NHL Season — Edmonton Oilers MVP", clues:["Won the Hart Trophy as league MVP","Led the NHL in scoring","Was part of an Oilers dynasty that won four Stanley Cups in five years in the 1980s","Considered the best player in the world"] },
...
const MEDIUM = [
  ...
  { player:"Vladimir Guerrero Jr.", sport:"⚾ MLB", answer:"VLADDY", era:"modern", stats:{HR:"48",AVG:".311",RBI:"111",OPS:"1.002"}, ctx:"2021 ML Season — Toronto Blue Jays", clues:["Led the AL in home runs and batting this season","Finished 2nd in MVP voting","Hit a home run in the 2021 All-Star Game Home Run Derby from a distance of 468 feet","His father was a Hall of Fame outfielder for the Montreal Expos and Anaheim Angels"] },
  // Baseball - Classic
  // Soccer - Modern
  ...
  { player:"Brett Hull", sport:"🏒 NHL", answer:"HULL", era:"classic", stats:{G:"86",AST:"45",PTS:"131",PIM:"24"}, ctx:"1990-91 NHL Season — St. Louis Blues", clues:["Scored 86 goals — 3rd most in NHL history","The Blues won their first Cup in 2019 after 52 years of trying — while Gloria played in the arena","His father was a Hall of Fame winger who scored 610 NHL goals","Scored 741 career goals — the most ever by a player whose father also played in the NHL"] },
