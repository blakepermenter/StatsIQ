...
const HARD = [
  ...
  { player:"Kyle Orton", sport:"🏈 NFL", answer:"KYLE ORTON", era:"modern", stats:{RTG:"87.0",YDS:"3802",W:"6",TEAM:"Broncos"}, ctx:"2009 NFL Season — Solid starter in Tim Tebow's shadow", clues:["Had a solid 2009 season with the Denver Broncos before being controversially replaced by Tim Tebow","Averaged 87 passer rating over his career — a quietly competent starter","Was often the subject of internet memes despite his respectable statistics","From Burket Indiana — played college football at Purdue"] },
  { player:"Trent Dilfer", sport:"🏈 NFL", answer:"TRENT DILFER", era:"modern", stats:{RTG:"70.2",SB:"Won 2001",PICK:"6th 1994",TEAM:"Ravens"}, ctx:"Super Bowl XXXV Champion — Won as game-manager for the Ravens", clues:["Won Super Bowl XXXV as a game-manager QB despite a career 70.2 passer rating","Was one of the most accomplished players of their generation","Was the 6th overall pick in the 1994 NFL Draft","From Santa Cruz California — became a well-known football analyst after retiring"] },
  ...
  { player:"Brad Johnson", sport:"🏈 NFL", answer:"BRAD JOHNSON HARD", era:"modern", stats:{YDS:"215",TD:"2",INT:"1",RTG:"101.8"}, ctx:"Super Bowl XXXVII MVP team — Tampa Bay Buccaneers", clues:["Won the Super Bowl with the Tampa Bay Buccaneers in 2003","His team won 48-21 — the most lopsided Super Bowl ever at that time","Was considered a game manager who relied on the defense","Scored 2 touchdowns during this season"] },
  ...
  { player:"Trent Dilfer", sport:"🏈 NFL", answer:"TRENT DILFER HARD", era:"modern", stats:{YDS:"153",TD:"1",INT:"0",RTG:"112.8"}, ctx:"Super Bowl XXXV MVP team — Baltimore Ravens", clues:["Won the Super Bowl with the Baltimore Ravens","Was considered the weakest link on a dominant defense-led team","Was one of the most accomplished players of their generation","Scored 1 touchdowns during this season"] },
  ...
  { player:"Quincy Carter", sport:"🏈 NFL", answer:"QUINCY CARTER HARD", era:"modern", stats:{YDS:"3302",TD:"16",INT:"11",RTG:"82.1"}, ctx:"2003 NFL Season — Dallas Cowboys", clues:["Was the starting quarterback for the Dallas Cowboys","Scored 16 touchdowns during this season","Was a second round pick in the 2001 NFL Draft","Was released before the 2004 season despite having a decent year"] },
  { player:"A.J. Feeley", sport:"🏈 NFL", answer:"AJ FEELEY HARD", era:"modern", stats:{YDS:"1011",TD:"6",INT:"2",RTG:"89.4"}, ctx:"2002 NFL Season — Philadelphia Eagles emergency starter", clues:["Went 4-1 as an emergency starter for the Eagles","Scored 6 touchdowns during this season","Was a 5th round draft pick out of Oregon","Later married Heather Mitts the soccer player"] },
  ...
  { player:"Bill Russell Legends", sport:"🏀 NBA", answer:"BILL RUSSELL 2", era:"legends", stats:{RINGS:"11",MVP:"5",BLOCKS:"Pioneered",COACH:"Player-coach"}, ctx:"Career Totals — 11 championships including 2 as player-coach", clues:["Was one of the most accomplished players of their generation","Became the first Black head coach in major American professional sports when he was named player-coach","Won 5 MVP awards and was the defensive anchor of the Boston Celtics dynasty","From Monroe Louisiana — transformed how the game of basketball was played defensively"] },
  ...
  // HARD Basketball Modern (need 3)
  { player:"Tobias Harris", sport:"🏀 NBA", answer:"TOBIAS HARRIS", era:"modern", stats:{PPG:"19.5",SEASON:"2021-22",TEAM:"76ers",CONTRACT:"$180M"}, ctx:"2021-22 NBA Season — Quietly excellent for Philadelphia", clues:["Averaged 19.5 points per game for the Philadelphia 76ers","Signed one of the largest contracts in NBA history at $180 million","Has been quietly one of the most consistent scorers in the league for a decade","From Islip New York — played college ball at Tennessee"] },
